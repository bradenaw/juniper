...
<h3><a id="Collect"></a><samp>func <a href="#Collect">Collect</a>[T any](iter <a href="#Iterator">Iterator</a>[T]) []T</samp></h3>

Collect advances iter to the end and returns all of the items seen as a slice.


<h3><a id="Equal"></a><samp>func <a href="#Equal">Equal</a>[T comparable](iters ...) bool</samp></h3>
...
false
```
<h3><a id="Last"></a><samp>func <a href="#Last">Last</a>[T any](iter <a href="#Iterator">Iterator</a>[T], n int) []T</samp></h3>
...
<h3><a id="Chan"></a><samp>func Chan[T any](c &lt;-chan T) <a href="#Iterator">Iterator</a>[T]</samp></h3>

Chan returns an Iterator that yields the values received on c.


<h3><a id="Chunk"></a><samp>func Chunk[T any](iter <a href="#Iterator">Iterator</a>[T], chunkSize int) <a href="#Iterator">Iterator</a>[[]T]</samp></h3>
...
[g h]
```
<h3><a id="Compact"></a><samp>func Compact[T comparable](iter <a href="#Iterator">Iterator</a>[T]) <a href="#Iterator">Iterator</a>[T]</samp></h3>
...
[bank ghost yaw]
```
<h3><a id="Counter"></a><samp>func Counter(n int) <a href="#Iterator">Iterator</a>[int]</samp></h3>
...
[2 4 6]
```
<h3><a id="First"></a><samp>func First[T any](iter <a href="#Iterator">Iterator</a>[T], n int) <a href="#Iterator">Iterator</a>[T]</samp></h3>
...
[a b c]
```
<h3><a id="Flatten"></a><samp>func Flatten[T any](iter <a href="#Iterator">Iterator</a>[<a href="#Iterator">Iterator</a>[T]]) <a href="#Iterator">Iterator</a>[T]</samp></h3>
...
[0 1 2 3 4 5 6 7]
```
<h3><a id="Join"></a><samp>func Join[T any](iters ...) <a href="#Iterator">Iterator</a>[T]</samp></h3>
...
<h3><a id="Repeat"></a><samp>func Repeat[T any](item T, n int) <a href="#Iterator">Iterator</a>[T]</samp></h3>
...
[[2 4 0] [7 1 3 9] [2 8]]
```
<h3><a id="Slice"></a><samp>func Slice[T any](s []T) <a href="#Iterator">Iterator</a>[T]</samp></h3>
...
<h3><a id="WithPeek"></a><samp>func WithPeek[T any](iter <a href="#Iterator">Iterator</a>[T]) <a href="#Peekable">Peekable</a>[T]</samp></h3>
