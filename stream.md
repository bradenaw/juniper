...
<h3><a id="Collect"></a><samp>func <a href="#Collect">Collect</a>[T any](ctx <a href="https://pkg.go.dev/context#Context">context.Context</a>, s <a href="#Stream">Stream</a>[T]) ([]T, error)</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L276">src</a></small></sub></h3>
...
[a b c]
```
<h3><a id="Last"></a><samp>func <a href="#Last">Last</a>[T any](ctx <a href="https://pkg.go.dev/context#Context">context.Context</a>, s <a href="#Stream">Stream</a>[T], n int) ([]T, error)</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L293">src</a></small></sub></h3>
...
[0 1 2]
```
<h3><a id="One"></a><samp>func <a href="#One">One</a>[T any](ctx <a href="https://pkg.go.dev/context#Context">context.Context</a>, s <a href="#Stream">Stream</a>[T]) (T, error)</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L319">src</a></small></sub></h3>
...
<h3><a id="WithPeek"></a><samp>func WithPeek[T any](s <a href="#Stream">Stream</a>[T]) <a href="#Peekable">Peekable</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L231">src</a></small></sub></h3>
...
<h3><a id="Close"></a><samp>func (s *<a href="#PipeSender">PipeSender</a>[T]) Close(err error)</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L191">src</a></small></sub></h3>
...
<h3><a id="Batch"></a><samp>func Batch[T any](s <a href="#Stream">Stream</a>[T], maxWait <a href="https://pkg.go.dev/time#Duration">time.Duration</a>, batchSize int) <a href="#Stream">Stream</a>[[]T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L368">src</a></small></sub></h3>
...
[a b c]
```
<h3><a id="Chunk"></a><samp>func Chunk[T any](s <a href="#Stream">Stream</a>[T], chunkSize int) <a href="#Stream">Stream</a>[[]T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L569">src</a></small></sub></h3>
...
[g h]
```
<h3><a id="Compact"></a><samp>func Compact[T comparable](s <a href="#Stream">Stream</a>[T]) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L610">src</a></small></sub></h3>
...
[a b c a]
```
<h3><a id="CompactFunc"></a><samp>func CompactFunc[T any](s <a href="#Stream">Stream</a>[T], eq func(T, T) bool) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L617">src</a></small></sub></h3>
...
foo
```
<h3><a id="Filter"></a><samp>func Filter[T any](s <a href="#Stream">Stream</a>[T], keep func(<a href="https://pkg.go.dev/context#Context">context.Context</a>, T) (bool, error)) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L656">src</a></small></sub></h3>
...
[2 4 6]
```
<h3><a id="First"></a><samp>func First[T any](s <a href="#Stream">Stream</a>[T], n int) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L687">src</a></small></sub></h3>
...
[a b c]
```
<h3><a id="Flatten"></a><samp>func Flatten[T any](s <a href="#Stream">Stream</a>[<a href="#Stream">Stream</a>[T]]) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L714">src</a></small></sub></h3>
...
<h3><a id="Join"></a><samp>func Join[T any](streams ...<a href="#Stream">Stream</a>[T]) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L756">src</a></small></sub></h3>
...
[0 1 2 0 1 2 3 4 0 1]
```
<h3><a id="Map"></a><samp>func Map[T any, U any](s <a href="#Stream">Stream</a>[T], f func(<a href="https://pkg.go.dev/context#Context">context.Context</a>, T) (U, error)) <a href="#Stream">Stream</a>[U]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L788">src</a></small></sub></h3>
...
[0 0.5 1 1.5 2]
```
<h3><a id="Merge"></a><samp>func Merge[T any](in ...<a href="#Stream">Stream</a>[T]) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L816">src</a></small></sub></h3>
...
y
```
<h3><a id="Runs"></a><samp>func Runs[T any](s <a href="#Stream">Stream</a>[T], same func(a, b T) bool) <a href="#Stream">Stream</a>[<a href="#Stream">Stream</a>[T]]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L873">src</a></small></sub></h3>
...
[2 8]
```
<h3><a id="While"></a><samp>func While[T any](s <a href="#Stream">Stream</a>[T], f func(<a href="https://pkg.go.dev/context#Context">context.Context</a>, T) (bool, error)) <a href="#Stream">Stream</a>[T]</samp><sub class="float-right"><small><a href="https://github.com/bradenaw/juniper/blob/main/stream/stream.go#L937">src</a></small></sub></h3>
